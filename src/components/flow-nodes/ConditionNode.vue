...
<style scoped>
.custom-node {
  min-width: 120px; width: 100%; background: white; border: 2px solid #f59e0b;
  border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,.1);
}
.custom-node.selected { border-color: #d97706; box-shadow: 0 4px 16px rgba(217,119,6,.3); }
.node-header {
  display: flex; align-items: center; padding: 10px 12px;
  background: #f59e0b; color: white; font-weight: 600; border-radius: 6px 6px 0 0;
}
...
.condition-display { display: flex; align-items: center; justify-content: center; padding: 4px; }
.operator { font-size: 13px; font-weight: 700; color: #f59e0b; }
</style>
